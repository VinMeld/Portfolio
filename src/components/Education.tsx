    ...
    <div className="flex flex-col md:flex-row justify-center my-20">
      <div className="w-full md:w-7/12">
        ...
        <div className="transition-transform transform-gpu hover:-translate-y-1 hover:scale-105">
          <ol
            className={`flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-700 transition-transform transform-gpu hover:-translate-y-1 hover:scale-105 ${isVisible ? "animate-slideUp" : "opacity-0"
              }`}
          >
